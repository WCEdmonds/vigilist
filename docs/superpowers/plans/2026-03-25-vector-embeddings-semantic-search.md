...
```bash
cd backend
VIGILIST_DATABASE_URL="postgresql+asyncpg://neondb_owner:npg_y3Yr1OHeVSoi@ep-noisy-frog-a8h520r3-pooler.eastus2.azure.neon.tech/neondb" python -m alembic upgrade head
```
